...
function Hero() {
  ...
  return (
    <section id="home"
      className="w-full p-2 flex xl:flex-row flex-col justify-start min-h-screen gap-10 max-container">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-lg:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        />
        <div className="flex sm:gap-2  gap-4  absolute -bottom-[5%] sm:w-24 justify-center items-center " >
          {
            shoes.map((shoe) => (
